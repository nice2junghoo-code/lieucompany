...
// shared by Showroom and DemoRequest — same locations/gallery/design, only the
// heading copy differs per page
function LocationsShowcase({
  heading,
  intro,
  sectionLabel,
  reservationNotice,
  ...
  return (
    <main className="px-6 py-16 lg:py-20">
      <h1 className="text-center text-[28px] font-[652] leading-[1.13] text-ink sm:text-[40px]">{heading}</h1>
      ...
      <div className="mx-auto mt-12 grid max-w-[1400px] grid-cols-1 gap-8 sm:grid-cols-[1fr_1fr] lg:grid-cols-[420px_1fr]">
        ...
        <div className="flex flex-col gap-4">
          <p className="text-[20px] font-[652] text-ink">{sectionLabel}</p>
                  ...
                  {loc.hours && (
                    <div className="flex items-start gap-2 text-[14px] text-text-muted">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-[13px] font-[700] text-red-600">{reservationNotice}</p>
                      </div>
                    </div>
                  )}
